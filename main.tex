...
% personal data
\name{Hasibulla}{Sahibzada}
\title{Software developer}                               % optional, remove / comment the line if not wanted
\phone[mobile]{+4915216967648}                   % optional, remove / comment the line if not wanted
%\phone[fixed]{+2~(345)~678~901}                    % optional, remove / comment the line if not wanted
%\phone[fax]{+3~(456)~789~012}                      % optional, remove / comment the line if not wanted
\email{Hasibullah@sahibzada.org}                               % optional, remove / comment the line if not wanted
%\homepage{https://www.xing.com/profile/Hasibullah_Sahibzada} 
